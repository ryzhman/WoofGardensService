...
module.exports.sendReminderDaily = (event, context, callback) => {
    ...
    var emailHtml = fs.readFileSync('./templates/dailyReminder.html', 'utf-8');

    var toAndFromAdress = 'ryzhman@gmail.com'
    var params = {
        Destination: {
    ...
    console.log(`Preparing to send the email to ${toAndFromAdress}`)
...
module.exports.sendReminderWeekend = (event, context, callback) => {
    ...
    var emailHtml = fs.readFileSync('./templates/weekendReminder.html', 'utf-8');
